...
class Discriminator(nn.Module):
    ...
    def __init__(self, input_nc, ndf=64, norm_layer=nn.BatchNorm2d, image_size=256):
    ...
    def forward(self, input_feature):
        ...
        features = self.model(input_feature)
        features = features.view(input_feature.shape[0], -1)
